// src/ai/flows/ai-crop-doctor-analysis.ts
'use server';
...
type AiCropDoctorInput = z.infer<typeof AiCropDoctorInputSchema>;
...
type AiCropDoctorOutput = z.infer<typeof AiCropDoctorOutputSchema>;
